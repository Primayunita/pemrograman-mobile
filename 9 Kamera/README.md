...
![Gambar 1](img/praktikum1_langkah1.png)
...
![Gambar 1](img/praktikum1_langkah2(1).png)

![Gambar 2](img/praktikum1_langkah2(2).png)
...
@override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Take a picture - 244107060094')),
...
![Gambar 1](img/praktikum1_langkah9.jpeg)
...
![Gambar 1](img/praktikum2_langkah1.png)
...
![Gambar 1](img/tugasno2(1).png)

**Hasil run:**

![Video](img/hasilrun.mp4)
...
void async maksudnya adalah fungsi yang tidak mengembalikan nilai, tetapi bisa menjalankan proses yang membutuhkan waktu (seperti akses kamera, ambil data, dll) tanpa membuat aplikasi freeze.

### 4. Jelaskan fungsi dari anotasi @immutable dan @override ?

*Jawab:*

- @immutable digunakan untuk menandai bahwa suatu class bersifat tidak dapat diubah setelah dibuat.
- @override digunakan untuk menandai bahwa sebuah method menggantikan method dari parent class.
